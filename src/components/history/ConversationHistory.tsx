...
import { MessageSquare, Trash2, Star, Clock, Copy, Check, Search, Grid, List, ChevronDown, SortDesc } from 'lucide-react'
...
export default function ConversationHistory() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      {/* Content Header */}
      <div className="relative bg-white/60 backdrop-blur-sm border-b border-slate-200/30">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-4">
              <div className="bg-white/80 backdrop-blur-sm border border-slate-200/50 rounded-xl px-4 py-3 text-center">
                <div className="text-xl font-bold text-slate-900">{conversations.length}</div>
                <div className="text-xs text-slate-600 font-medium">Total Chats</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm border border-slate-200/50 rounded-xl px-4 py-3 text-center">
                <div className="text-xl font-bold text-slate-900">{conversations.reduce((acc, conv) => acc + (conv.responses?.length || 0), 0)}</div>
                <div className="text-xs text-slate-600 font-medium">AI Responses</div>
              </div>
            </div>
          </div>
          {/* Search and Filters */}
