    ...
    <div className={`min-h-screen transition-colors duration-500 ${
                ...
                <>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="relative group">
                      <div className={`w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold cursor-pointer transition-all duration-200 hover:scale-105 ${
                        darkMode ? 'ring-2 ring-white/30' : ''
                      }`}
                      >
                        {profilePicture ? (
                      ...
                      {/* Dropdown menu */}
                      <div className={`absolute right-0 mt-2 w-48 rounded-xl shadow-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 ${
                        darkMode 
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className={`absolute top-1/4 left-1/4 w-96 h-96 rounded-full blur-3xl animate-pulse ${
            darkMode ? 'bg-violet-500/20' : 'bg-blue-400/20'
          }`}></div>
          ...
          <div className={`absolute top-3/4 left-1/2 w-64 h-64 rounded-full blur-2xl animate-pulse ${
            darkMode ? 'bg-blue-500/15' : 'bg-pink-400/15'
          }`} style={{animationDelay: '2s'}}></div>
          
          {/* Floating geometric shapes */}
          <div className={`absolute top-1/3 right-1/3 w-8 h-8 rounded-lg rotate-45 animate-bounce ${
            darkMode 
              ? 'bg-gradient-to-br from-violet-500 to-purple-500' 
              : 'bg-gradient-to-br from-blue-500 to-purple-500'
          }`} style={{animationDelay: '0.5s'}}></div>
          <div className={`absolute bottom-1/3 left-1/5 w-6 h-6 rounded-full animate-bounce ${
            darkMode 
              ? 'bg-gradient-to-br from-pink-500 to-orange-500' 
              : 'bg-gradient-to-br from-pink-500 to-orange-500'
          }`} style={{animationDelay: '1.5s'}}></div>
          <div className={`absolute top-1/2 left-3/4 w-4 h-12 rounded-full animate-pulse ${
            darkMode 
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className={`inline-flex items-center space-x-2 backdrop-blur-sm rounded-full px-4 py-2 mb-8 relative overflow-hidden ${
              darkMode 
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              <div className="flex items-center space-x-4 text-slate-600 dark:text-gray-400">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map((i) => (
                    <div key={i} className={`w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 border-2 ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className={`group text-center p-6 backdrop-blur-sm rounded-2xl border transition-all duration-300 hover:scale-105 relative overflow-hidden ${
                darkMode 
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className={`inline-flex items-center space-x-2 backdrop-blur-sm rounded-full px-4 py-2 mb-6 relative overflow-hidden ${
              darkMode 
                ? 'bg-gray-800/60 border border-gray-700/50' 
                : 'bg-white/60 border border-slate-200/50'
            }`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className={`group relative backdrop-blur-sm border rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:scale-105 ${
                    darkMode 
      ...
      <section className={`py-24 relative ${
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className={`absolute bottom-1/4 left-1/4 w-64 h-64 rounded-full blur-2xl ${
            darkMode ? 'bg-purple-500/10' : 'bg-purple-300/10'
          }`}></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index} 
                className={`group backdrop-blur-sm border rounded-2xl p-8 hover:shadow-xl transition-all duration-300 hover:scale-105 relative overflow-hidden ${
                  darkMode 
                    ? 'bg-gray-800/60 border-gray-700/50' 
              ...
              >
                ...
                <div className="relative z-20">
                  ...
                  {/* Quote decoration */}
                  <div className={`absolute top-4 right-4 text-6xl font-serif ${
                    darkMode ? 'text-gray-700/50' : 'text-slate-200/50'
                  }`}>
                    &ldquo;
                  </div>
                </div>
      ...
      <section className={`py-24 relative overflow-hidden ${
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          {/* Floating geometric shapes */}
          <div className={`absolute top-1/4 left-1/4 w-32 h-32 rounded-full animate-bounce ${
            darkMode ? 'bg-white/5' : 'bg-white/5'
          }`} style={{animationDelay: '1s', animationDuration: '4s'}}></div>
          <div className={`absolute bottom-1/4 right-1/4 w-24 h-24 rounded-lg rotate-45 animate-pulse ${
            darkMode ? 'bg-white/5' : 'bg-white/5'
          }`} style={{animationDelay: '2s'}}></div>
          <div className={`absolute top-3/4 right-1/3 w-16 h-16 rounded-full animate-bounce ${
            darkMode ? 'bg-white/5' : 'bg-white/5'
        ...
        <div className={`absolute inset-0 bg-gradient-to-t ${
          darkMode ? 'from-black/20 to-transparent' : 'from-black/10 to-transparent'
        }`}></div>
        
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* Enhanced heading with animated underline */}
          <div className="relative inline-block mb-6">
            <h2 className={`text-4xl sm:text-5xl font-bold relative z-10 ${
